          ...
          <div class="w-full max-w-md rounded-md p-6 max-h-[85vh] overflow-y-auto" style="background: #ffffff; box-shadow: 0 16px 48px rgba(0,0,0,0.25)">
            ...
            <div x-show="isDesktop">
              ...
              <ul class="space-y-2 text-sm" style="color: #0f172a">
                ...
                <li class="flex items-start gap-3"><span class="mt-0.5 inline-block px-2 py-0.5 rounded-md font-mono text-[11px] font-semibold" style="background: #eef2ff; color: var(--ih-primary, #6366f1)">⌘K</span><span>Command palette · pages, recent inspections, <span class="font-mono">&gt;</span> actions, <span class="font-mono">@</span> people</span></li>
