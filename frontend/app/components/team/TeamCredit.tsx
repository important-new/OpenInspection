...
export function TeamCredit({ team, nachi }: TeamCreditProps) {
  return (
    <section className="border-t border-slate-200 mt-12 pt-6 pb-12 max-w-3xl mx-auto px-4">
      <h3 className="text-[10px] font-bold uppercase tracking-widest text-slate-400 mb-3">Inspected by</h3>
